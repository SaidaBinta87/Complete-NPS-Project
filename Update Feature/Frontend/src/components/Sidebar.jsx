...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform bg-gray-50 dark:bg-gray-800">
      <div className="h-full px-3 py-4 overflow-y-auto">
        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            <a href="/dynamicSurvey" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              {/* Add icon */}
              ...
              <span className="ml-3">Create Survey</span>
            </a>
          </li>
