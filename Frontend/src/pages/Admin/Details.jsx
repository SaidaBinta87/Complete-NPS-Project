        ...
        {npsData && (
          <div className="grid grid-cols-2 gap-8 mb-8">
            ...
            <div className="block max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <p className="cursor-pointer font-normal text-gray-700 dark:text-gray-400" onClick={() => handleCategoryClick('promoters')}>Promoters: {npsData.totalPromoters}</p>
              <p className="cursor-pointer font-normal text-gray-700 dark:text-gray-400" onClick={() => handleCategoryClick('passives')}>Passives: {npsData.totalPassives}</p>
              <p className="cursor-pointer font-normal text-gray-700 dark:text-gray-400" onClick={() => handleCategoryClick('detractors')}>Detractors: {npsData.totalDetractors}</p>
            </div>
          </div>
        )}
